...
const SCHEMA = {
  ...
  required: ["prepTimeMinutes", "cookTimeMinutes", "servings", "difficulty", "caloriesPerServing"],
  additionalProperties: false,
};

const SYSTEM_PROMPT = `You extract structured recipe metadata (prep time, cook time, servings, difficulty, estimated calories) from recipe text (ingredients + steps).
